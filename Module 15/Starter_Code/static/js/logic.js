...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function (data) {
  ...
  function getColor(depth) {
    ...
    else if (depth > 10 && depth < 30) return "#d9f0a3";
    else if (depth > 30 && depth < 50) return "#addd8e";
    else if (depth > 50 && depth < 70) return "#78c679";
    else if (depth > 70 && depth < 90) return "#31a354";
    else return "#006837";
  };
  ...
  info.onAdd = function () {
    ...
    let colors = ["#ffffcc", "#d9f0a3", "#addd8e", "#78c679", "#31a354", "#006837"];
...
d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then(function (plate_data) {
  // Save the geoJSON data, along with style information, to the tectonic_plates layer.
    L.geoJson(plate_data, {
      color: "orange",
      weight: 2}).addTo(layers.tectonic_plates);
